...
> therefore force—is already a sick civilization, a civilization which
> is morally diseased[.] —Aimé Césaire
...
attempted to exclude (this list is non-exhaustive):

- Words spelled with punctuation or non-ASCII characters, including
  cases where the spelling is arguable
- Words likely to be confused for a homophone if read over an audio
  channel, or are simply obscure enough that the pronunciation might
  be unknown
- Words that might be distracting, embarrassing, offensive, or profane,
  particularly to marginalized groups
- Proper nouns, particularly place names, exonyms, and endonyms
- Words related to religion, race, sexuality, etc (for this and the
  previous category, no words are problematic in and of themselves, but
  because the list includes many adjectives with negative connotations,
  they could be part of a combination of words which is)
...
- Names of drugs, alcoholic drinks, or foods that are categorically not
...
of this kind that continuing to use indifferently-chosen ones simply
because they are common in our society is a deliberate choice. If you
believe politics should be kept out of software and engineering, it's
because your politics are already well-represented in capitalist,
...
This list was compiled by myself, a white, abled, queer, transgender
American woman with a Northeastern accent working in technology. In
addition to the limitations of my cultural perspective, in which I am
immensely privileged and have rarely been made to feel inferior for my
diction or vocabulary, I have had to edit this README tens of times
to dial down pretentious word choices.
...
angry that I had to do it. Unfortunately, even in 2020, actually
existing password systems remain generally xenophobic and user-hostile
in their handling of non-ASCII and even non-alphabetic ASCII characters.
